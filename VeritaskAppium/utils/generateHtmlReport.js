...
export function generateHtmlReport(results, outputDir = 'Test_Results/HTML') {
...
<head>
  ...
  <title>VeriTask Mobile E2E Emulator Execution Report</title>
  <style>
    :root {
      --bg-color: #0b0f19;
      --card-bg: #111827;
...
<body>
  ...
  <header>
    <div class="logo-section">
      <h1><span>VeriTask</span> Mobile E2E Automation</h1>
    </div>
    <div class="timestamp">
  ...
  fs.writeFileSync(path.join(resolvedDir, 'execution-report.html'), htmlContent, 'utf-8');
  console.log(`HTML report successfully generated at: ${path.join(resolvedDir, 'execution-report.html')}`);
}
